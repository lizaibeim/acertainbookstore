...
public class StockManagerTest {
	 ...
	 */
	@Test
	public void testaddBookInvalidISBN() throws BookStoreException, InterruptedException {
	 ...
	 */
	@Test
	public void testAddBookInvalidCopies() throws BookStoreException, InterruptedException {
		List<StockBook> booksInStorePreTest = storeManager.getBooks();
	 ...
	 */
	@Test
	public void testAddBookInvalidPrice() throws BookStoreException, InterruptedException {
		List<StockBook> booksInStorePreTest = storeManager.getBooks();
	 ...
	 */
	@Test
	public void testRemoveBooks() throws BookStoreException, InterruptedException {
	 ...
	 */
	@Test
	public void testGetBooksByISBN() throws BookStoreException, InterruptedException {
		Set<StockBook> booksToAdd = new HashSet<StockBook>();
	 ...
	 */
	@Test
	public void testRemoveAllBooks() throws BookStoreException, InterruptedException {
		Set<StockBook> booksToAdd = new HashSet<StockBook>();
		booksToAdd.add(new ImmutableStockBook(TEST_ISBN + 1, "The Art of Computer Programming", "Donald Knuth",
				(float) 300, NUM_COPIES, 0, 0, 0, false));
		booksToAdd.add(new ImmutableStockBook(TEST_ISBN + 2, "The C Programming Language",
